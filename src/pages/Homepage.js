    ...
    <>
      ...
      <div className='deneme'>
        <div>
          ...
          <button className='sign-up-now' onClick={handleClickCreateAccount}>
            SIGN UP NOW
          </button>
        </div>
        ...
        <div>
          ...
          <span className='text-4'>
            Do more than just play... Advanced stats let you track your progress
        ...
        <div>
          ...
          <span className='text-6'>
            Find others to play with in seconds! You'll get matched with equally
            ranked and like-minded gamers to improve your skill and learn from
            the best.
          </span>
        </div>
